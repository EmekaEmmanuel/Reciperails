...
RSpec.describe 'Showing all Public Recipes', type: :feature do
  before(:all) do
  ...
  scenario 'I can see the public recipe name.' do
    visit public_recipes_path
    expect(page).to have_content(@first_recipe.name)
  end

  scenario 'I can see the creator of the pubic recipe.' do
    visit public_recipes_path
